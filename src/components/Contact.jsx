...
export default function Contact() {
  return (
    <ChakraProvider>
        <Container bg="#9DC4FB" maxW="full" mt={0} mb={4} centerContent overflow="hidden">
            <Heading as='h1' mt={12} mb={8} color={'black'}>Contact Me</Heading>
      <Flex mb={20}>
        <Box
          bg="#02054B"
          color="white"
            ...
            <Wrap spacing={{ base: 20, sm: 3, md: 5, lg: 20 }}>
              <WrapItem>
                <Box>
                  ...
                  <Box py={{ base: 5, sm: 5, md: 8, lg: 10 }} textAlign={'justify'}>
